...
public class PazienteService {
    ...
    public List<Map<String, Object>> getDatiPaziente(Long pazienteId) {
        List<Map<String, Object>> risultati = new ArrayList<>();
        List<Map<String, Object>> queryResult = repo.getDatiPaziente(pazienteId);
    ...
    public List<Map<String, Object>> getPazientiByEsameAndIntervaloTemporale(String nomeEsame, String dataInizio ,  String dataFine) {
        List<Map<String, Object>> risultati = new ArrayList<>();
        List<Map<String, Object>> queryResult = repo.getPazientiByEsameAndIntervaloTemporale(nomeEsame, dataInizio, dataFine);
